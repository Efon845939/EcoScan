  ...
  const handleSubmit = async () => {
    ...
    startTransition(async () => {
      ...
      try {
        ...
        toast({ variant: 'destructive', title: 'Analysis Failed', description: e?.message || String(e) });
        setStep('form');
        return;
      }
  ...
  return (
    <Card className="w-full">
      <CardHeader>
        ...
        <CardDescription className="text-center pt-2">{t('survey_description')}</CardDescription>
      </CardHeader>
      ...
      <CardFooter>
        <Button
          ...
          disabled={isPending || transport.length === 0 || diet.length === 0 || drink.length === 0}
        >
